...
I've coded in several languages, including Java, C#/.NET, C, C++, Python, JavaScript, Go, and Rust.
...
- Various build tools including [Cargo](https://github.com/chrislattman/test-cargo), [CMake](https://github.com/chrislattman/test-cmake), [Gradle](https://github.com/chrislattman/datastructuresgradle), and [uv](https://github.com/chrislattman/datastructuresuv)
...
- [Built-in de/serialization methods](https://github.com/chrislattman/test-pickle)
  - Includes a little bit of Docker and Nix
...
- [Multithreaded socket programming](https://github.com/chrislattman/webserver)
  ...
  - [Bare-metal Rust](https://github.com/chrislattman/test-bare-metal-pico-rs-webserver) embassy-net (embassy and smoltcp) web server for the Raspberry Pi Pico 2 W board
...
- Embedded projects:
  ...
  - [Bare-metal C and SystemVerilog](https://github.com/chrislattman/test-xilinx-hw-sw-co-design) hardware/software co-design project
...
- Shared memory between processes in [Linux/macOS](https://gist.github.com/chrislattman/39cba2fdb21a044a0b5bcea230988e08) and [Windows](https://gist.github.com/chrislattman/eff797931d75cb7c878bd33ea247bc19)
